    ...
    <table class="table table-hover table-bordered">
        ...
        while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="quantityProductId<?php echo $id;?>" 
                    value="1" min="1" required class="" id="">
                </td>
                <td> <input type="checkbox" class="" value="<?php echo $id; ?>" 
                name="productCheckId[]" id="checkBox"
                ></td>
            </tr>
